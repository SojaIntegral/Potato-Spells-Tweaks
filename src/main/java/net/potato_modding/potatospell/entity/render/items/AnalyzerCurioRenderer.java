package net.potato_modding.potatospell.entity.render.items;
...
import net.potato_modding.potatospell.config.ClientConfigs;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class AnalyzerCurioRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        if(!ClientConfigs.ANALYZER_RENDER.get()) renderHigher = -1.15f;

        poseStack.translate(4.5 * .0625f, 16 * .0625f, 0);
