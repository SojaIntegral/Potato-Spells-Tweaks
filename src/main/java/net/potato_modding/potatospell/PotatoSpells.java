...
package net.potato_modding.potatospell;
...
import net.potato_modding.potatospell.entity.render.items.AnalyzerCurioRenderer;
import net.potato_modding.potatospell.registry.*;
