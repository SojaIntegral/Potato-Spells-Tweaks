package net.potato_modding.potatospell.registry;

import io.redspace.ironsspellbooks.api.spells.AbstractSpell;
import net.neoforged.bus.api.IEventBus;
import net.neoforged.neoforge.registries.DeferredRegister;
import net.potato_modding.potatospell.PotatoSpells;
import net.potato_modding.potatospell.spells.ManaShieldSpell;
import net.potato_modding.potatospell.spells.ManaStealSpell;
import net.potato_modding.potatospell.spells.MassRecallSpell;
