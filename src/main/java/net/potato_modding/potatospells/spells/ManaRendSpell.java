...
@AutoSpellConfig
public class ManaRendSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(PotatoSpells.MOD_ID, "mana_rend_spell");
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(
                ...
                Component.translatable("attribute.modifier.plus.1", Utils.stringTruncation((int) (getSpellPower(spellLevel, caster)  * 0.25), 0), Component.translatable("potatospellbookstweaks.mana_rend"))
        );
    }
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        entity.addEffect(new MobEffectInstance(PotatoEffects.MANA_REND,
