...
public class RavenousDebuff extends MobEffect {
    public RavenousDebuff() {
        super(MobEffectCategory.HARMFUL, 0x38daa0);
        this.addAttributeModifier(PotatoAttributes.SLAYER, PotatoSpells.id("hunger"),
                -0.05, AttributeModifier.Operation.ADD_VALUE);
        this.addAttributeModifier(ALObjects.Attributes.CRIT_CHANCE, PotatoSpells.id("hunger"),
                -0.05, AttributeModifier.Operation.ADD_VALUE);
        this.addAttributeModifier(AttributeRegistry.COOLDOWN_REDUCTION, PotatoSpells.id("hunger"),
                -0.05, AttributeModifier.Operation.ADD_VALUE);
    }
