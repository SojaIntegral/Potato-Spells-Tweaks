...
public class DeeplingWarlock {
    ...
    private static void handleResistanceAttributeCataclysm(EntityJoinLevelEvent event) {
        ...
        if (typeKey.getNamespace().equals("cataclysm") && typeKey.getPath().equals("deepling_warlock")) {
            ...
            LigRes += 0.85 * mob_mod;
            EldRes += 1.6 * mob_mod;
            AbyssRes += 2.35 * mob_mod;
            BladeRes += 0.05 * mob_mod;
            SoundRes += 0.65 * mob_mod;
