...
public class Aptrgangr {
    ...
    private static void handleResistanceAttributeCataclysm(EntityJoinLevelEvent event) {
        ...
        if ((typeKey.getNamespace().equals("cataclysm") && typeKey.getPath().equals("aptrgangr")) ||
                (typeKey.getNamespace().equals("cataclysm_spellbooks") && typeKey.getPath().equals("summoned_aptrgangr"))) {
