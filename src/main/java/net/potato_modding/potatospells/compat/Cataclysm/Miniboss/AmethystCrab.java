...
public class AmethystCrab {
    ...
    private static void handleResistanceAttributeCataclysm(EntityJoinLevelEvent event) {
        ...
        if ((typeKey.getNamespace().equals("cataclysm") && typeKey.getPath().equals("amethyst_crab")) ||
                (typeKey.getNamespace().equals("cataclysm_spellbooks") && typeKey.getPath().equals("summoned_amethyst_crab"))) {
