    ...
    private static void handleResistanceAttributePreset(EntityJoinLevelEvent event) {
        ...
        if (mob.getType().is(PotatoTags.MAGE_WIND)) {
            ...
            // Updates mob attributes
            {
                ...
                setIfNonNull((LivingEntity) mob, com.snackpirate.aeromancy.spells.AASpells.Attributes.WIND_SPELL_POWER, SchoolPower);
