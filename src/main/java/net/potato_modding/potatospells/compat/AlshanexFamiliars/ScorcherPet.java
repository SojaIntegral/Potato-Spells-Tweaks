...
public class ScorcherPet {
    ...
    private static void handleResistanceAttribute(FinalizeSpawnEvent event) {
        ...
        if (typeKey.getNamespace().equals("alshanex_familiars") && typeKey.getPath().equals("scorcher_pet")
            ...
            SpellPower += 1.1 * mob_mod * attrVar[0];
            Resist += 1.1 * mob_mod * attrVar[1];
            FireRes += 1.5 * mob_mod * attrVar[2];
            IceRes += 1.2 * mob_mod * attrVar[2];
            HolyRes += 0.8 * mob_mod * attrVar[2];
            ...
            EldRes += 1.2 * mob_mod * attrVar[2];
            AbyssRes += 0.8 * mob_mod * attrVar[2];
            BladeRes += mob_mod * attrVar[2];
            SoundRes += mob_mod * attrVar[2];
            WindRes += 0.8 * mob_mod * attrVar[2];
            Armor += 3 * spec_mod * attrVar[3];
            ...
            // Updates mob attributes
            {
                ...
                setIfNonNull(mob, ALObjects.Attributes.CRIT_DAMAGE, 1.55 * attrVar[9]);
            }
