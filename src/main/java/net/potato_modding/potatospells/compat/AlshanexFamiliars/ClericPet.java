...
public class ClericPet {
    ...
    private static void handleResistanceAttribute(FinalizeSpawnEvent event) {
        ...
        if (typeKey.getNamespace().equals("alshanex_familiars") && typeKey.getPath().equals("cleric_pet")
            ...
            EvokeRes += 1.2 * mob_mod * attrVar[2];
            ...
            // Updates mob attributes
            {
                ...
                setIfNonNull(mob, ALObjects.Attributes.CRIT_DAMAGE, 1.25 * attrVar[9]);
            }
