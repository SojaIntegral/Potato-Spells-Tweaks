...
public class HunterPet {
    ...
    private static void handleResistanceAttribute(FinalizeSpawnEvent event) {
        ...
        if (typeKey.getNamespace().equals("alshanex_familiars") && typeKey.getPath().equals("hunter_pet")
            ...
            // Updates mob attributes
            {
                ...
                setIfNonNull(mob, ALObjects.Attributes.CRIT_CHANCE, 0.35 * attrVar[8]);
