...
public class ArchmagePet {
    ...
    private static void handleResistanceAttribute(FinalizeSpawnEvent event) {
        ...
        if (typeKey.getNamespace().equals("alshanex_familiars") && typeKey.getPath().equals("archmage_pet")
