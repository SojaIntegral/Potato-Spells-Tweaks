...
public class IllusionistPet {
    ...
    private static void handleResistanceAttribute(FinalizeSpawnEvent event) {
        ...
        if (typeKey.getNamespace().equals("alshanex_familiars") && typeKey.getPath().equals("illusionist_pet")
            ...
            FireRes += mob_mod * attrVar[2];
            IceRes += mob_mod * attrVar[2];
            HolyRes += 0.8 * mob_mod * attrVar[2];
            NatRes += mob_mod * attrVar[2];
            EvokeRes += 0.5 * mob_mod * attrVar[2];
            BloodRes += 1.5 * mob_mod * attrVar[2];
            ...
            WindRes += 1.2 * mob_mod * attrVar[2];
            Armor += 6 * spec_mod * attrVar[3];
            Tough += 6 * spec_mod * attrVar[4];
            ...
            // Updates mob attributes
            {
                ...
                setIfNonNull(mob, ALObjects.Attributes.CRIT_CHANCE, 0.25 * attrVar[8]);
